      ...
      case OPEN:
        return (
          <span className="election-status">
            ...
            <span className="election-status-text">
              {Translations[context].statusOpen}
            </span>
          </span>
        );
      case CLOSED:
        return (
          <span className="election-status">
            ...
            <span className="election-status-text">
              {Translations[context].statusClose}
            </span>
          </span>
        );
      case SHUFFLED_BALLOT:
        return (
          <span className="election-status">
            <span className="election-status-closed"></span>
            <span className="election-status-text">
              {Translations[context].statusShuffle}
            </span>
          </span>
        );
      case RESULT_AVAILABLE:
        return (
          <span className="election-status">
            <span className="election-status-closed"></span>
            <span className="election-status-text">
              {Translations[context].resultsAvailable}
            </span>
          </span>
        );
      case CANCELED:
        return (
          <span className="election-status">
            ...
            <span className="election-status-text">
              {Translations[context].statusCancel}
            </span>
          </span>
        );
      default:
